...
import EpicerieImg from "../../images/epicerie.jpg"
        ...
        <section className="epicerie bg-white py-4">
            <div className="epicerie-market flex flex-col px-4 lg:px-0">
                <div className="header flex justify-between items-center py-10">
                    <h2 className='font-bold text-2xl lg:text-3xl'>Epicerie</h2>
                    <Link to={"/epicerie-stores"} className='text-xs font-semibold underline'>Voir plus</Link>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                    <Link to={"/epicerie-store-details"} className="box">
                        <div className="bg-black text-white flex flex-col justify-center items-center border">
                            <img src={EpicerieImg} alt=""/>
...
//   return (
//     <>
//         <section className="epicerie bg-black text-white py-4">
//             <div className="epicerie-market flex flex-col px-4 lg:px-0">
//                 <div className="header flex justify-between items-center py-10">
