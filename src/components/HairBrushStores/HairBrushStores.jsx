...
import mecheImg from '../../images/meche.jpg'
import { faMapLocationDot, faPhone, faSearch } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { Link } from 'react-router-dom'

function HairBrushStores() {
    return (
        <>
            <section className="all-wick-stores my-10">
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-4 lg:px-0">
                        <Link to={"/hair-brush-store-details"} className="box bg-red-600 text-white transition duration-500 ease-in-out hover:opacity-70">
                            <img src={mecheImg} className="" alt="" />
...
export default HairBrushStores;