...
import cosmeticImg from '../../images/cosmetic.jpg'
import { faMapLocationDot, faPhone, faSearch } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { Link } from 'react-router-dom'

function CosmeticsStores() {
    return (
        <>
            <section className="all-cosmetic-stores my-10">
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-4 lg:px-0">
                        <Link to={"/cosmetic-store-details"} className="box bg-yellow-600 text-white transition duration-500 ease-in-out hover:opacity-70">
                            <img src={cosmeticImg} className="" alt="" />
                            <div className="flex flex-col items-center">
                                <h1 className='text-2xl lg:text-3xl '>Nady Boutique</h1>
                                <div className="flex flex-col items-center ">
...
export default CosmeticsStores