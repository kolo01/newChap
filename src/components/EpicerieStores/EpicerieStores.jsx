            ...
            <section className="all-epicerie-stores my-10">
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-4 lg:px-0">
                        <Link to={"/epicerie-store-details"} className="box bg-cyan-700 text-white transition duration-500 ease-in-out hover:opacity-70">
                            <img src={epicerieImg} className="" alt="" />
